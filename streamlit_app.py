...
def main():
    ...
    <div class="page-header">
        ...
        <p class="page-subtitle">Ask questions about Singtel ECOM documentation. Powered by Agentic RAG.</p>
    </div>
    """, unsafe_allow_html=True)
    ...
    with st.form("search_form", clear_on_submit=False):
        question = st.text_input(
            label="question",
            placeholder="e.g. How does the ECOM billing process work?",
        )
        ...
        with col_tip:
            st.markdown(
                ...
                'Be specific for the best results.</p>',
                unsafe_allow_html=True,
            )
